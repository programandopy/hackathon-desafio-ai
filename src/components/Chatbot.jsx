        ...
        <div>
            ...
            <div style={{ boxShadow: '0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05)' }}
                ...
                <div className="pr-4 h-[474px]" style={{ minWidth: '100%', display: 'table' }}>
                    ...
                    <div className="flex gap-3 my-4 text-gray-600 text-sm flex-1">
                        ...
                        <p className="leading-relaxed">
                            <span className="block font-bold text-gray-700">AI </span>Hola, ¿qué lugares turisticos de Encarnación te gustaria visitar?
                        </p>
                    </div>
                    ...
                    <div className="flex gap-3 my-4 text-gray-600 text-sm flex-1">
                        ...
                        <p className="leading-relaxed">
                            <span className="block font-bold text-gray-700">You </span> Recomiendame lugares bailables.
                        </p>
                    </div>
                    ...
                    <div className="flex gap-3 my-4 text-gray-600 text-sm flex-1">
                        ...
                        <p className="leading-relaxed">
                            <span className="block font-bold text-gray-700">AI </span>Claro, estos son los...
                        </p>
                    </div>
                </div>
                ...
                <div className="w-full flex items-center border-t py-2">
                    <input type="text" placeholder="Type a message..." className="flex-1 border-none p-2 text-gray-700 focus:outline-none" />
